...
- Keep repo CI gates from `AGENTS.md` unchanged unless this plan documents an intentional policy change (then update the editioned **`docs/development-plan-v{N}.md`**, `docs/tech-stack.md`, and related docs per governance).
