...
- When architecture, testing policy, or release gates change, remind to keep **docs** in sync per repo guidance (`docs/product-requirements-v1.md`, `docs/technical-design-v1.md`, `docs/development-plan-v1.md`, `docs/tech-stack.md`).
...
- When sequencing work against the active editioned development plan **Section 12** (e.g. **`docs/development-plan-v1.md`**; see **`docs/templates/development-plan-template.md`**), validation works like this:
