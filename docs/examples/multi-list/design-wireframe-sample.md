...
> **Repository note:** This file is a **sample** preserved under [`docs/examples/README.md`](../README.md). For new wireframe docs, use [`docs/templates/design-wireframe-template.md`](../templates/design-wireframe-template.md).
