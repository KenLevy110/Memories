...
| **Related docs** | [README.md](../README.md); [tech-stack.md](tech-stack.md); [memories-user-workflow.md](memories-user-workflow.md) (**screenshots + flow**); [Prototype Backend Engineering Handoff.md](Prototype%20Backend%20Engineering%20Handoff.md); TBD: [technical-design.md](technical-design.md), [development-plan.md](development-plan.md) |
...
Hi-fi **screenshots**, a **mermaid** flow, **ASCII** layout sketches, and a **PRD/TDD trace** table live in **[memories-user-workflow.md](memories-user-workflow.md)** (`docs/assets/workflow-screenshots/`). Use that doc for PRD alignment, technical-design screen-to-API mapping, and wireframe references (hi-fi source of truth + low-fi boxes).
...
**Milestones:** TDD v0.1 (maps FR/NFR to APIs, storage, authz source, offline queue); STT eval (~20 samples, Section 3.4); cross-product MVP pilot Section 12.1 (TBD timeline ~3–6 mo order-of-magnitude, Section 12.4).
...
Author **technical-design.md** (`.cursor/skills/technical-designer/`) with FR/NFR traceability and handoff section cites for capture, authz, logging, AI, and **NFR-012** (elder-friendly simplicity). Then **development-planner** after TDD sketch. Keep handoff revs in sync with **Related docs** here.
