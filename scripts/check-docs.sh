...
[[ -f scripts/resolve-cursor-transcripts-dir.mjs ]] || err "scripts/resolve-cursor-transcripts-dir.mjs missing"
[[ -f scripts/resolve-cursor-transcripts-dir.test.mjs ]] || err "scripts/resolve-cursor-transcripts-dir.test.mjs missing"
[[ -f scripts/setup-git-hooks.mjs ]] || err "scripts/setup-git-hooks.mjs missing"
[[ -f scripts/setup-git-hooks.ps1 ]] || err "scripts/setup-git-hooks.ps1 missing"
